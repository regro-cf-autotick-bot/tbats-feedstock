...
Once the `conda-forge` channel has been enabled, `tbats` can be installed with:

```
conda install tbats
```

It is possible to list all of the versions of `tbats` available on your platform with:
